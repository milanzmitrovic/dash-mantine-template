...
__init__.py 
    ...
    All functions that are defined inside radio_button/ folder 
    and that should be used externally are imported in 
    __init__.py file so that they can be user as gc.radio_button...
...
Component.py
    ...
    *** component()
    ...
    --> It will be imported and instantiated in all 
        places where RADIO_BUTTON component is used 
        (There could be several components of type RADIO_BUTTON, 
        and this is expected actually).

    --> We use template to create specific instance 
        of RADIO_BUTTON component.
