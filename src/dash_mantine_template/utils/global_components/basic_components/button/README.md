...
__init__.py 
    ...
    All functions that are defined inside button/ folder 
    and that should be used externally are imported in 
    __init__.py file so that they can be user as gc.button...
...
Component.py
    ...
    *** component()
    ...
    --> It will be imported and instantiated in all 
        places where BUTTON component is used 
        (There could be several components of type BUTTON, 
