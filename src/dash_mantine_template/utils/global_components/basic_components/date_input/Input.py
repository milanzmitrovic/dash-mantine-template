...
related with date_input component.

Here we define what (default) property of
date_input component will trigger callback.
...
def input_dummy(id_: str) -> Input:
    ...
    default date, min/max dates can be set based on
    business logic or database values).
    """
