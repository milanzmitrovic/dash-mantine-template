...
__init__.py 
    ...
    All functions that are defined inside multiselect/ folder 
    and that should be used externally are imported in 
    __init__.py file so that they can be user as gc.multiselect...
...
Component.py
    ...
    *** component()
    ...
    --> It will be imported and instantiated in all 
        places where MULTISELECT component is used 
        (There could be several components of type MULTISELECT, 
        and this is expected actually).
    
    --> We use template to create specific instance 
        of MULTISELECT component.
